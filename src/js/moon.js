...
import bays from "/src/collected/Bays.json" assert { type: "json" };
import lakes from "/src/collected/Lakes.json" assert { type: "json" };
import mountainrange from "/src/collected/Mountain_Range.json" assert { type: "json" };
import mountains from "/src/collected/Mountains.json" assert { type: "json" };
import seas from "/src/collected/Seas.json" assert { type: "json" };
import valleys from "/src/collected/Valleys.json" assert { type: "json" };
import craters from "/src/collected/Craters.json" assert { type: "json" };
